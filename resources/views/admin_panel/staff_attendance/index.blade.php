...
<style>
.summary-card{border-left:5px solid;padding:15px;border-radius:6px;background:#fff}
.summary-present{border-color:#198754}
.summary-absent{border-color:#dc3545}
.summary-leave{border-color:#ffc107}
.summary-half{border-color:#0dcaf0}
.summary-card h4{margin:0;font-weight:600}
...
<td>
<button class="btn btn-sm btn-info viewHistoryBtn" data-staff="{{ $row->staff_id }}">History</button>
<button class="btn btn-sm btn-primary editBtn" data-id="{{ $row->id }}">Edit</button>
<button class="btn btn-sm btn-danger deleteAttendanceBtn" data-id="{{ $row->id }}">Del</button>
</td>
</tr>
@empty
