        ...
        <div class="content">
            <div class="page-header">
                <div class="page-title">
                    <h4>Contractor Recoveries</h4>
                    <h6>Track all recoveries from contractors</h6>
                </div>
            </div>
                                            ...
                                            <div class="modal fade" id="editRecoveryModal{{ $recovery->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <form method="POST"
                                                            action="{{ route('contractor_recovery.update', $recovery->id) }}">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="modal-header">
                                                                <h5 class="modal-title"
                                                                    id="editRecoveryModalLabel{{ $recovery->id }}">Edit
                                                                    Contractor Recovery</h5>
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        value="{{ $recovery->contractor->contractor_name ?? 'N/A' }}"
                                                                        readonly>
                                                                </div>
